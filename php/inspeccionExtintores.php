...
function enviarCorreoConPdf($correo, $pdfPath) {
    ...
    try {
        ...
        $mail->isHTML(true);
        $mail->Subject = 'INSPECCION EXTINTORES';
        $mail->Body = "Inspeccion Extintores.";
        $mail->addAttachment($pdfPath, 'inspeccion_extintores.pdf');
        $mail->send();
...
// Variable para el resultado del envío
$resultado = '';
